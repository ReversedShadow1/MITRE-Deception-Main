...
class AdvancedEnsembleMethod:
    ...
    '''def ensemble_extractors(
        ...
        """
        Combine results from multiple extractors with adaptive ensemble
        ...
        for tech_id in technique_ids:
            ...
            for extractor_name, results in extractor_results.items():
                ...
                for result in results:
                    if result.get("technique_id") == tech_id:
                        ...
                        # Apply calibration
                        calibrated_confidence = self._calibrate_confidence(extractor_name, raw_confidence)
            ...
            if tech_id in self.techniques_data:
                ...
                if description:
                    ensemble_result["description"] = description[:200] + "..." if len(description) > 200 else description
    ...
    # Add this to AdvancedEnsembleMethod in src/api/v2/routes/Advanced_Ensemble.py
